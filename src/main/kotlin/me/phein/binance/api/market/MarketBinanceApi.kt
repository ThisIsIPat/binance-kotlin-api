...
interface MarketBinanceApi {
     ...
     * @param limit Default 500; max 1000.
     * @param fromId Default 500; max 1000.
     *
     * @see <a href="https://binance-docs.github.io/apidocs/spot/en/#compressed-aggregate-trades-list">Binance API documentation</a>
     */
    suspend fun aggTrades(symbol: String, limit: Int = 500, startTime: Long?, endTime: Long?, fromId: Long? = null): List<AggTrade>
     ...
     */
    suspend fun klines(symbol: String, interval: KlineInterval, startTime: Long, endTime: Long, limit: Int = 500): List<Kline>
